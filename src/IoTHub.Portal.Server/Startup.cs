    ...
    > Ex: ``Authorization: Bearer * ***``",
        ...
        private static void AddAuthenticationAndAuthorization(IServiceCollection services, ConfigHandler configuration)
        {
            ...
            _ = services.AddAuthorization(options =>
                {
                    options.AddPolicy("group:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("group:read"));
                    });
                    options.AddPolicy("group:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("group:write"));
                    });
                    options.AddPolicy("access-control:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("access-control:read"));
                    });
                    options.AddPolicy("access-control:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("access-control:write"));
                    });
                    options.AddPolicy("access-control:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("access-control:write"));
                    });
                    options.AddPolicy("device:export", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device:export"));
                    });
                    options.AddPolicy("device:import", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device:import"));
                    });
                    options.AddPolicy("device:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device:write"));
                    });
                    options.AddPolicy("device:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device:read"));
                    });
                    options.AddPolicy("device-configuration:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device-configuration:read"));
                    });
                    options.AddPolicy("device-configuration:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device-configuration:write"));
                    });
                    options.AddPolicy("model:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("model:read"));
                    });
                    options.AddPolicy("model:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("model:write"));
                    });
                    options.AddPolicy("device-tag:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device-tag:read"));
                    });
                    options.AddPolicy("device-tag:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("device-tag:write"));
                    });
                    options.AddPolicy("edge-device:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("edge-device:read"));
                    });
                    options.AddPolicy("edge-device:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("edge-device:write"));
                    });
                    options.AddPolicy("edge-device:execute", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("edge-device:execute"));
                    });
                    options.AddPolicy("edge-model:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("edge-model:read"));
                    });
                    options.AddPolicy("edge-model:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("edge-model:write"));
                    });
                    options.AddPolicy("idea:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("idea:write"));
                    });
                    options.AddPolicy("layer:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("layer:read"));
                    });
                    options.AddPolicy("layer:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("layer:write"));
                    });
                    options.AddPolicy("planning:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("planning:read"));
                    });
                    options.AddPolicy("planning:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("planning:write"));
                    });
                    ...
                    {
                        policy.Requirements.Add(new PermissionRequirement("role:write"));
                    });
                    options.AddPolicy("schedule:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("schedule:read"));
                    });
                    options.AddPolicy("schedule:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("schedule:write"));
                    });
                    options.AddPolicy("setting:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("setting:read"));
                    });
                    options.AddPolicy("concentrator:read", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("concentrator:read"));
                    });
                    options.AddPolicy("concentrator:write", policy =>
                    {
                        policy.Requirements.Add(new PermissionRequirement("concentrator:write"));
                    });
