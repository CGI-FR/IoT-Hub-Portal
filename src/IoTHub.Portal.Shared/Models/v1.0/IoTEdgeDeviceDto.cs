...
namespace IoTHub.Portal.Models.v10
{
    ...
    public class IoTEdgeDeviceDto
    {
        ...
        /// </summary>
        public ConfigItemDto LastDeployment { get; set; }

        /// <summary>
        /// The IoT Edge modules.
        /// </summary>
        public IReadOnlyCollection<IoTEdgeModuleDto> Modules { get; set; } = new List<IoTEdgeModuleDto>();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IoTEdgeDeviceDto"/> class.
        /// </summary>
        public IoTEdgeDeviceDto()
        {
            this.IsEnabled = true;
        }
    }
